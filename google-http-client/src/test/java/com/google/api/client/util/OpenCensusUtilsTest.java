...
public class OpenCensusUtilsTest extends TestCase {
  ...
  public void testLogMessageEventInNullSpan() {
    try {
      OpenCensusUtils.logMessageEvent(null, 0, NetworkEvent.Type.SENT);
      fail("expected " + IllegalArgumentException.class);
    } catch (IllegalArgumentException e) {
      assertEquals(e.getMessage(), "span should not be null.");
    }
  ...
  public void testLogMessageEvent() {
    try {
      OpenCensusUtils.logMessageEvent(mockSpan, 0, NetworkEvent.Type.SENT);
      fail("expected " + UnsupportedOperationException.class);
    } catch (UnsupportedOperationException e) {
